  ...
  -- Syntax Highlighting
  {
    ...
    opts = {
      ensure_installed = {
        ...
        "typescript", "json", "jsonc", "tsx", "markdown", "markdown_inline", "c", "cpp", "rust", "python", "bash",
        "yaml", "toml", "cmake", "make", "dockerfile", "gitignore", "go", "sql", "java", "terraform", "hcl", "prisma", "groovy",
      },
    },
  },
  -- Git
