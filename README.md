...
- **Formatting (conform.nvim)**: `stylua`, `prettier`, `clang_format`, `rustfmt`, `terraform_fmt`, `shfmt`
- **Linting (nvim-lint)**: `eslint_d`, `markdownlint`, `tflint`, `yamllint`, `ansible_lint`, `shellcheck`, `actionlint`
